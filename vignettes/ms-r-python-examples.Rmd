...
### tidymodels [dashboard](https://modeloriented.github.io/modelStudio/tidymodels.html)
...
modelStudio(explainer, B = 5,
            options = ms_options(margin_left = 160, showcase_name='scikitlearn'))
```
...
# make a studio for the model
library(modelStudio)
modelStudio(explainer, options = ms_options(showcase_name='lightgbm'))
```
...
# make a studio for the model
library(modelStudio)
modelStudio(explainer, options = ms_options(showcase_name='keras'))
```
