...
Treat the binary variables (e.g. one-hot-encoding) as categorical and use bar plots. Set the `binary` parameter to `FALSE` to remove this feature 
and treat these variables as any other numerical variable by default.
